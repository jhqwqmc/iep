...
object MinSpeedMode : Mode {
    ...
    override fun create(player: Player) = Generator.create(player) { MinSpeedGenerator() }

    override fun getItem(locale: String) = Item(Material.SPLASH_POTION, "<white><bold>Min Speed")
}